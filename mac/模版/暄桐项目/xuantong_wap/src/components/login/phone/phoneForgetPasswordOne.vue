        ...
        <div class="mobile_content pl-40 pr-40">
            <div class="email_content">
                ...
                <form action="">
                    ...
                    <mt-button class="mt-40" size="large" type="primary" @click.prevent="goPhoneForgetPasswordTwo">下一步</mt-button>
                </form>
            </div>
        </div>
...
import {phoneVerification,captchaVerification,nowTime, 
    captchaDownTime} from '../../../public/index'
export default {
    ...
    methods: {
               ...
               if(this.phone !=''){  
                    ...
                    if( this.$refs.phone  && this.$refs.phone.innerHTML == ''){
                        ...
                        if(!(this.phoneHaveData.result)){
                            ...
                            this.$refs.phone.innerHTML='手机号不存在';
                        }
                    }
                }
            },100)   
        ...
        async changeImgShow () {
            ...
            if(this.$refs.phone.innerHTML == ''){
                this.verification = false;
                await this.getPhoneGetCaptchaAction({phoneNumList:[this.phone],sendType:3});
        ...
        async goPhoneForgetPasswordTwo(){
            let phone='',captcha = ''
            ...
            if(phone && captcha &&  this.captchaData.result && this.phoneHaveData.result && 
                this.captchaHaveData.result){
                this.$router.push({
                    path:'/phoneforgetpasswordtwo',
                    query:{mobile:this.phone,confirmCode:this.captcha}
                })
            }
        }
    }
