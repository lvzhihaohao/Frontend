                                ...
                                <div className="col-lg-6 col-md-12">
                                    <div className="hosting-banner-image">
                                        <ReactWOW delay='0.7s' animation='fadeInDown'>
                                            <img 
                                                src={require("../../static/images/hosting-banner-image/1.png")}
                                                alt="image"
                                            />
                                        </ReactWOW>
                                        <ReactWOW delay='0.7s' animation='fadeInDown'>
                                            <img 
                                                src={require("../../static/images/hosting-banner-image/2.png")}
                                                alt="image"
                                            />
                                        </ReactWOW>
                                        <ReactWOW delay='0.7s' animation='fadeInDown'>
                                            <img 
                                                src={require("../../static/images/hosting-banner-image/3.png")} 
                                                alt="image"
                                            />
                                        </ReactWOW>
                                        <ReactWOW delay='0.7s' animation='fadeInDown'>
                                            <img 
                                                src={require("../../static/images/hosting-banner-image/4.png")}
                                                alt="image"
                                            />
                                        </ReactWOW>
                                        <ReactWOW delay='0.7s' animation='fadeInDown'>
                                            <img 
                                                src={require("../../static/images/hosting-banner-image/5.png")} 
                                                alt="image"
                                            />
                                        </ReactWOW>
                                        <ReactWOW delay='0.7s' animation='fadeInDown'>
                                            <img 
                                                src={require("../../static/images/hosting-banner-image/6.png")}
                                                alt="image"
                                            />
                                        </ReactWOW>
                                        <ReactWOW delay='0.7s' animation='fadeInDown'>
                                            <img 
                                                src={require("../../static/images/hosting-banner-image/7.png")}
                                                alt="image"
                                            />
                                        </ReactWOW>
                                        <ReactWOW delay='0.7s' animation='fadeInDown'>
                                            <img 
                                                src={require("../../static/images/hosting-banner-image/8.png")}
                                                alt="image"
                                            />
                                        </ReactWOW>
                                        <ReactWOW delay='0.7s' animation='fadeInDown'>
                                            <img 
                                                src={require("../../static/images/hosting-banner-image/9.png")}
                                                alt="image"
                                            />
                                        </ReactWOW>
                                        <ReactWOW delay='0.5s' animation='fadeInUp'>
                                            <img 
                                                src={require("../../static/images/hosting-banner-image/static-main.png")}
                                                alt="image"
                                            />
                                        </ReactWOW>
                                    </div>
