                        ...
                        <div className="col-lg-6">
                            <div className="repair-banner-image">
                                ...
                                <ReactWOW delay='0.6s' animation='zoomIn'>
                                    <img 
                                        src={require('../../static/images/repair-banner-image/1.png')} 
                                ...
                                <ReactWOW delay='0.6s' animation='fadeInRight'>
                                    <img 
                                        src={require('../../static/images/repair-banner-image/2.png')} 
                                ...
                                <ReactWOW animation='rotateme'>
                                    <img 
                                        src={require('../../static/images/repair-banner-image/circle.png')} 
                                        className="rotateme" 
                                        alt="image" 
                                    />
                                </ReactWOW>
