                                        ...
                                        <ul className="dropdown_menu">
                                            ...
                                            <li className="nav-item">
                                                <Link activeClassName="active" href="#">
                                                    <a 
                                                        className="nav-link"
                                                        onClick={e => e.ChevronLeft()}
                                                    >
                                                        Home Three <Icon.ChevronLeft />
                                                    </a>
                                                </Link>
                                                <ul className="dropdown_menu">
                                                    <li className="nav-item">
